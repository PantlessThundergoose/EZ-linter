...
class Header extends Component {
    ...
    render(){
        ...
        for(let i = 0; i < Object.keys(this.props.rules).length; i++){
            rules.push(<Rule label={Object.keys(this.props.rules)[i]} key={Object.keys(this.props.rules)[i]} header={this.props.label} bool={Object.values(this.props.rules)[i]} updateCode={this.props.updateCode}/>)
        }
